...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ checkTodo)\n/* harmony export */ });\n/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../index.js */ \"./src/index.js\");\n/* eslint-disable import/no-cycle */\n\n\nfunction checkTodo(selectedId) {\n  let check = _index_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"][selectedId].completed;\n\n  if (check === true) {\n    check = false;\n  } else {\n    check = true;\n  }\n  _index_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"][selectedId].completed = check;\n\n  localStorage.setItem('todoList', JSON.stringify(_index_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]));\n}\n\n//# sourceURL=webpack://to-do-list/./src/modules/check.js?");
